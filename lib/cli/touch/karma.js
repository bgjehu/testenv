...
module.exports = {
    ...
    replacements: {
        ...
        BROWSERIFY_PLUGINS_STRING: 'require(\'testenv\').karma_browserify,',
        BROWSERIFY_ISTANBUL_PLUGINS_STRING: 'require(\'testenv\').browserify_istanbul,',
        KARMA_COVERAGE_PLUGINS_STRING: 'require(\'testenv\').karma_coverage,',
